...
namespace Kooboo.CMS.Web.Areas.Contents.Controllers
{
    ...
    public class ContentServiceController : SubmissionControllerBase
    {
        ...
        public ActionResult Create(string folderName, string schemaName, string parentFolder, string parentUUID)
        {
        ...
        public ActionResult Update(string folderName, string schemaName, string uuid)
        {
            TextFolder textFolder;
            Schema schema;
            GetSchemaAndFolder(folderName, schemaName, out textFolder, out schema);
        ...
        public ActionResult Delete(string folderName, string schemaName, string uuid)
        {
            TextFolder textFolder;
            Schema schema;
            GetSchemaAndFolder(folderName, schemaName, out textFolder, out schema);
