    ...
    $(function () {
        ...
        $('textarea.tinymce').each(function () {
            ...
            var tinyMCEConfig = {
                ...
                theme: "advanced",
                theme_advanced_buttons1: "search,replace,undo,redo,|,KoobooMediaLibrary" + (hasSiteName ? ",KoobooPageSelector" : "") + ",image,link,unlink,charmap,|,bold,italic,fontselect,forecolor,backcolor,|,numlist,bullist,formatselect,|,code,fullscreen",
