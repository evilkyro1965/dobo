...
<table><tr>
            <td>
            <label for="Key"><%: "Anahtar Kelime"%></label><a href="javascript:;" class="tooltip-link" title="<%: "Parametre için belirleyici anahtar kelime" %>"></a>
            </td>
            <td>
            <input id="Key" name="Key" type="text" value="<%= Model.Key ?? ""%>" />
