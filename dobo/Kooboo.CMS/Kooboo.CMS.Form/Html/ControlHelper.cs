...
namespace Kooboo.CMS.Form.Html
{
    public static class ControlHelper
    {
        ...
        public static bool IsImage(string controlType)
        {
            return controlType.EqualsOrNullEmpty("ImageCrop", StringComparison.OrdinalIgnoreCase);
        }
        ...
        public static string Render(this IColumn column, bool isUpdate)
        {
            ...
            controlHtml = controls[controlType].Render(column);
