    ...
    public static class ModuleActionResultExecutor
    {
        ...
        private class RedirectToRouteResultWrapper : RedirectToRouteResult
        {
            ...
            public override void ExecuteResult(ControllerContext context)
            {
                ...
                {
                    throw new InvalidOperationException(SR.System_Web_Mvc_Resources.GetString("RedirectAction_CannotRedirectInChildAction"));
                }
        ...
        public static void ExecuteExclusiveResult(ControllerContext controllerContext, ActionResult actionResult)
        {
            if (IsExclusiveResult(actionResult))
            {
                ...
                {
                    actionResult = new RedirectToRouteResultWrapper((RedirectToRouteResult)actionResult, ((ModuleControllerBase)controllerContext.Controller).ModuleContext.RouteTable);
                }
