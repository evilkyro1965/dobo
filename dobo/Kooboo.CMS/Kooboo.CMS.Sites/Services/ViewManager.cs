...
{
    public class ViewManager : PathResourceManagerBase<Kooboo.CMS.Sites.Models.View>
    {
        ...
        public Namespace<Models.View> GetNamespace(Site site, params string[] exculdes)
        {
        ...
        public IEnumerable<Kooboo.CMS.Sites.Models.View> ByNamespace(Site site, string ns, string filter)
        {
        ...
        public void Localize(string name, string fromSite, Site targetSite)
        {
            ...
            var source = new Models.View(sourceSite, name);
            ((IViewProvider)Provider).Localize(source, targetSite);
        }

        #region Relations
        public IEnumerable<Page> RelationsPages(Models.View view)
        {
            if (view.Exists())
            {
                view = view.AsActual();
        ...
        public void Copy(Site site, string sourceName, string destName)
        {
