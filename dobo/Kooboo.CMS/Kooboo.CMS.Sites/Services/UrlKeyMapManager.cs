...
{
    public class UrlKeyMapManager : ManagerBase<UrlKeyMap>, IManager<UrlKeyMap>
    {
        ...
        {
            ((IUrlKeyMapProvider)Provider).Export(site, outputStream);
        }

        public void Import(Site site, System.IO.Stream zipStream, bool @override)
        {
            ((IUrlKeyMapProvider)Provider).Import(site, zipStream, @override);
        }
