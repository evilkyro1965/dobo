...
namespace Kooboo.CMS.Content.Query
{
    public static class TextContentQueryExtensions
    {
        ...
        //public static IContentQuery<TextContent> Categorizables(this IContentQuery<TextContent> source, TextFolder categorizableFolder)
        //{
        //    return new CategorizablesQuery(source.Repository, categorizableFolder, source);
        //}
        //public static IContentQuery<TextContent> Categorizables(this TextContent category, TextFolder categorizableFolder)
        //{
        //    var categoryFolder = new TextFolder(new Repository(category.Repository), category.FolderName);
        //    return categoryFolder.CreateQuery().WhereEquals("UUID", category.UUID).Categorizables(categorizableFolder);
        //}
