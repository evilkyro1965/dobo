    ...
    public static class DatabaseHelper
    {
        ...
        public static void DisposeDatabase(Repository repository)
        {
            if (SqlServerSettings.Instance.SharingDatabase)
            {
                ...
                //SchemaManager.DropTable(repository, repository.GetMediaContentTableName());
            }
            else
            {
                var managerConnectionString = SqlServerSettings.Instance.CreateDatabaseSetting;
                DropDatabase(repository, managerConnectionString);

                SqlServerSettings.Instance.RemoveConnection(repository.Name);
                SqlServerSettings.Instance.Save();
            }
        }
    }
