...
namespace Kooboo.CMS.Sites.Globalization
{
    public class SiteLabelRepository : IElementRepository
    {
        ...
        {
            StoreRepository = new CacheElementRepository(new XmlElementRepository(new Label(site).PhysicalPath));
        }
        ...
        {
            return this.StoreRepository.Get(name, category, FileCulture);
        }
