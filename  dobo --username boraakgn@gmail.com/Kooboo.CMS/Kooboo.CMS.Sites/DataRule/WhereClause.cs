...
namespace Kooboo.CMS.Sites.DataRule
{
    ...
    public static class WhereClauseToContentQueryHelper
    {
        ...
        //    }
        //}
        public static IWhereExpression Parse(this IEnumerable<WhereClause> clauses, IValueProvider valueProvider)
        {
            ...
            {
                var exp = GetExpression(null, clause, valueProvider);
                if (exp == null)
                {
                    continue;
                }
        ...
        private static IWhereExpression GetExpression(IWhereExpression inner, WhereClause clause, IValueProvider valueProvider)
        {
            ...
            switch (clause.Operator)
            {
                case Operator.Equals:
                    return new WhereEqualsExpression(inner, clause.FieldName, value);
                case Operator.NotEquals:
                    return new WhereNotEqualsExpression(inner, clause.FieldName, value);
                case Operator.GreaterThan:
                    return new WhereGreaterThanExpression(inner, clause.FieldName, value);
                case Operator.LessThan:
                    return new WhereLessThanExpression(inner, clause.FieldName, value);
                case Operator.Contains:
                    return new WhereContainsExpression(inner, clause.FieldName, value);
                case Operator.StartsWith:
                    return new WhereStartsWithExpression(inner, clause.FieldName, value);
                case Operator.EndsWith:
                    return new WhereEndsWithExpression(inner, clause.FieldName, value);
                case Operator.Between:
                    var value2 = ParameterizedFieldValue.GetFieldValue(clause.Value2, valueProvider);
                    return new WhereBetweenExpression(inner, clause.FieldName, value, value2);
                default:
                    return null;
            }
        }
