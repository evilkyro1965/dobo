...
namespace Kooboo.CMS.Web.Areas.Sites.Controllers
{
    ...
    public class CustomFileController : AdminControllerBase
    {
        ...
        [HttpPost]
        public ActionResult Create(CustomFile model, string fullName)
        {
            Msg msg = new Msg();
            try
            {
        ...
        public ActionResult Delete(string fullName, string fileName, string fileType)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Import(string fullName, bool @override)
        {
        ...
        public ActionResult Export(string fullName)
        {
            CustomDirectory dir = new CustomDirectory(Site, fullName ?? "");
