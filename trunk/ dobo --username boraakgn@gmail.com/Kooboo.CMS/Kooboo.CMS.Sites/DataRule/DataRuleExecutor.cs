    ...
    public static class DataRuleExecutor
    {
        ...
        public static void Execute(ViewDataDictionary viewData, DataRuleContext dataRuleContext, IEnumerable<DataRuleSetting> dataRules)
        {
            foreach (var item in dataRules)
            {
                ...
                {
                    data = GetData(item, (IContentQuery<ContentBase>)data);
                }
        ...
        private static object GetData(DataRuleSetting dataRuleSetting, IContentQuery<ContentBase> contentQuery)
        {
        ...
        private static object GetCacheData(TakeOperation operation, IContentQuery<ContentBase> contentQuery, CacheItemPolicy policy, Func<object> getData)
        {
