...
namespace Kooboo.CMS.Sites.DataRule
{
    ...
    {
        public ViewParameterValueProvider(IEnumerable<Parameter> viewParameters)
        {
            this.ViewParameters = viewParameters;
        }
        public IEnumerable<Parameter> ViewParameters { get; private set; }
        ...
        public object GetValue(string name)
        {
            ...
            {
                var parameter = ViewParameters.Where(it => it.Name.EqualsOrNullEmpty(name, StringComparison.OrdinalIgnoreCase)).FirstOrDefault();
                if (parameter != null)
                {
