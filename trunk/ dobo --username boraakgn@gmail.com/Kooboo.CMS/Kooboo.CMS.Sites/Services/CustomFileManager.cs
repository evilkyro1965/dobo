...
{
    public class CustomFileManager : PathResourceManagerBase<CustomFile>
    {
        public IEnumerable<CustomFile> All(CustomDirectory directory)
        {
        ...
        public void SaveFile(Site site, string fullName, string fileName, Stream fileSream)
        {
        ...
        public void Delete(Site site, string fullName, string fileName)
        {
            var nameArr = CustomDirectoryHelper.SplitFullName(fullName);
        ...
        public void CreateDirectory(Site site, CustomDirectory parentDir, string folderName)
        {
        ...
        #region Import
        public void Import(Site site, CustomDirectory dir, Stream stream, bool @override)
        {
        ...
        #region Export
        public void Export(CustomDirectory dir, Stream stream)
        {
