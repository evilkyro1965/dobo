...
namespace Kooboo.CMS.Search
{
    public class DocumentConverter
    {
        ...
        public virtual ResultObject ToResultObject(Highlighter highlighter, Document doc)
        {
            ...
            result.HighlightedTitle = highlighter.GetBestFragment(Analyzer, TitleFieldName, result.Title);
            ...
            Thread thread = new Thread(() =>
{
    ...
    catch (Exception e)
    {
        ...
        {
            if (string.IsNullOrEmpty(key) && (folders == null || folders.Length == 0))
            {
            ...
            var searcher = new IndexSearcher(FSDirectory.Open(new DirectoryInfo(indexDir)), true);
            ...
            Lucene.Net.Highlight.Highlighter lighter =
                       new Highlighter(new SimpleHTMLFormatter("<strong class='highlight'>", "</strong>"), new Lucene.Net.Highlight.QueryScorer(query));
