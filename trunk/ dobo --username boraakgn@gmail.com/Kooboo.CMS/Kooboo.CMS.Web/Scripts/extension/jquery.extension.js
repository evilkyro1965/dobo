...
(function ($) {
    ...
    $.fn.tableSorter = function (optoin) {
        ...
        function createCursorNearDiv(handle, left, cfg) {
            ...
            sorter = $('<span><a href="javascript:" class="o-icon move-up inline-action">Move up</a> <a href="javascript:" class="o-icon move-down inline-action">Move up</a><a href="javascript:" class="o-icon move inline-action">drag</a></span>');
