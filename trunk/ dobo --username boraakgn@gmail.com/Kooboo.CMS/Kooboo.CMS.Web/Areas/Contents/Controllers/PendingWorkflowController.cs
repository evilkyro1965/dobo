...
namespace Kooboo.CMS.Web.Areas.Contents.Controllers
{
    ...
    public class PendingWorkflowController : ManagerControllerBase
    {
        ...
        public ActionResult Process(string roleName, string name)
        {
        ...
        [HttpPost]
        public ActionResult Process(string workflowName,string roleName, string name, bool passed, string comment)
        {
        ...
        public ActionResult WorkflowHistory(string UUID, string folderName)
        {
