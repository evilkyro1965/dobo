...
namespace Kooboo.CMS.Web.Areas.Contents.Controllers
{
    ...
    public class SchemaController : ManagerControllerBase
    {
        ...
        // GET: /Content/Schema/
        [HttpGet]
        public ActionResult Index(string search, string schemaName, bool? Finish)
        {
        ...
        [HttpPost]
        public ActionResult Create(Schema schema, bool? finish)
        {
        ...
        [HttpGet]
        public ActionResult Edit(string schemaName)
        {
            return View(Manager.Get(Repository, schemaName).AsActual());
        }
        [HttpPost]
        public ActionResult Edit(Schema newModel, string old_key, bool? finish, bool Next, bool resetAll)
        {
            JsonResultEntry resultEntry = new JsonResultEntry(ModelState);
            try
            {
        ...
        public ActionResult Export(Schema[] model)
        {
        ...
        #region Templates
        public ActionResult Templates(string schemaName)
        {
        ...
        [HttpPost]
        public ActionResult Templates(string schemaName, List<FormModel> formList, bool templateBuildByMachine)
        {
            JsonResultEntry resultEntry = new JsonResultEntry(ModelState);
            try
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult ResetAll(string schemaName, FormType CurrentFormType)
        {
            JsonResultEntry resultEntry = new JsonResultEntry(ModelState);
            try
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult ResetCurrent(FormType CurrentFormType, string schemaName)
        {
        ...
        #region Relations
        public ActionResult Relations(string schemaName)
        {
        ...
        public ActionResult ColumnForms(Schema model)
        {
            return View(model);
        }
