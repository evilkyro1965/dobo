...
namespace Kooboo.CMS.Web.Areas.Contents.Controllers
{
    public class MediaFolderController : ManagerControllerBase
    {
        ...
        public ActionResult Index(string fullName, string search)
        {
        ...
        [HttpPost]
        public ActionResult Create(MediaFolder model, string folderName)
        {
        ...
        [HttpPost]
        public ActionResult Edit(string folderName)
        {
        ...
        public ActionResult Delete(string selectedFolders)
        {
            var entry = new JsonResultEntry();
            try
            {
