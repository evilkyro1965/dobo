...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="common-form ">
        ...
        <fieldset class="orderSetting">
            <legend class="clickable"><span>
                <%:"Content display order".Localize()%></span><a href="javascript:;" class="tooltip-link" title="<%: "The content item display order in the content list page. Default is Sequence with possibility to change the order of each content item".Localize() %>">
        </a> </legend>
            <table>
                <tbody>
                    <%:Html.EditorFor(m => m.OrderSetting, new { @class = "medium" })%>
                </tbody>
            </table>
        </fieldset>
        <p class="buttons">
