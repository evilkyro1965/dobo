...
namespace Kooboo.CMS.Web.Areas.Sites.Controllers
{
    ...
    public abstract class PathResourceControllerBase<T, Service> : IManagerControllerBase<T, Service>
        ...
        where Service : PathResourceManagerBase<T>
    {
        ...
        [HttpPost]
        public virtual ActionResult Import(string name, bool @override)
        {
            ...
            try
            {
                ...
                {
                    Manager.Import(Site, name, Request.Files[0].InputStream, @override);
                }
            }
            catch (Exception e)
            {
        ...
        #region Export
        [HttpPost]
        public virtual void Export(T[] model)
        {
        ...
        //public virtual ActionResult Export(string name)
        //{
        //    var fileName = GetZipFileName(name);
        //    Response.AttachmentHeader(fileName);
        //    if (!string.IsNullOrEmpty(name))
        //    {
        //        Manager.Export(Site, name, Response.OutputStream);
        //    }
        //    else
        //    {
        //        Manager.ExportAll(Site, Response.OutputStream);
        //    }
        //    return null;
        //}
