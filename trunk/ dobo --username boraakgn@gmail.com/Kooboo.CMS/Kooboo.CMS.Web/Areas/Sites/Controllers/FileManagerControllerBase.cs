...
namespace Kooboo.CMS.Web.Areas.Sites.Controllers
{
    public abstract class FileManagerControllerBase : AdminControllerBase
    {
        ...
        public ActionResult CreateFile(string directoryPath)
        {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult CreateFile(string directoryPath, string name, string fileExtension, string body)
        {
        ...
        [HttpPost]
        public ActionResult LargeFile(string directoryPath)
        {
        ...
        #region EditFile
        public ActionResult EditFile(string virtualPath)
        {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult EditFile(string directoryPath, string virtualPath, string name, string fileExtension, string body)
        {
            JsonResultEntry result = new JsonResultEntry(ModelState);
            try
            {
        ...
        /// <returns></returns>
        public ActionResult IsNameAvailable(string directoryPath, string name, string fileExtension, string old_Key)
        {
        ...
        public ActionResult CreateDirectory(string directoryPath)
        {
            return View();
        }
        [HttpPost]
        public ActionResult CreateDirectory(string directoryPath, string name)
        {
        ...
        public ActionResult EditDirectory(string directoryPath)
        {
            return View();
        }
        [HttpPost]
        public ActionResult EditDirectory(string directoryPath, string name)
        {
            var entry = new JsonResultEntry();
            try
            {
        ...
        [HttpPost]
        public ActionResult Delete(string directoryPath, IEnumerable<string> filePaths, IEnumerable<string> directoryPaths)
        {
            var entry = new JsonResultEntry();
            try
            {
        ...
        public ActionResult RediretToIndex()
        {
            return RediretToIndex(Request.RequestContext.AllRouteValues());
        }

        public ActionResult RediretToIndex(object routeValues)
        {
        ...
        [HttpPost]
        public ActionResult Import(string directoryPath, bool @overrided)
        {
            var entry = new JsonResultEntry();
            try
            {
