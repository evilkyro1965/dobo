...
(function ($) {
    ...
    if (contentIframe) {
        ...
        if (isRepeatCss.w || isRepeatCss.h) {
    ...
    yardi.designCtx = {
        ...
        dragSetting: {
            ...
            helper: function () {
                // create
                var er = $(this).clone();
                er.find('.htmlcon').remove(); // remove before appendTo body, or scripts in htmlcon will be executed.
                er.appendTo('body').find('.title').width(70);
                // width
                var innerWidth = 0;
    ...
    */
    ...
    // index.js was loaded at last and this function place at the end.
