...
namespace Kooboo.CMS.Web.Areas.Sites.Models
{
    ...
    [GridAction(DisplayName = "Localization", ActionName = "Localize", ConfirmMessage = "Are you sure you want to localize this item?", RouteValueProperties = "Name,fromSite=Site", Order = 3, Class = "o-icon localize", Renderer = typeof(LocalizationRender))]
