    ...
    kooboo.cms.content.schema.column.extend({
        ...
        init: function (formName) {
            ...
            var form = $('#Column' + formName + '-form').find('form'),
             ...
             fromFolderSwitcher = form.find('input:radio[name$=Manual]');
            ...
            function handleFromFolderSwitcher(switcher) {
                var effect = 'fade';
                if (switcher.filter('[checked]').val() == 'Manual') {
    ...
    $(function () {
        ...
        $("#btn_CreateColumn").unbind('click').pop({
            ...
            onload: function (handle, pop, config) {
                ...
                if (columnCount <= 0) {
                    form.find('input:checkbox[name$=Summarize]').attr('checked', true);
                    form.find('input:checkbox[name$=ShowInGrid]').attr('checked', true);
                }
            }
        });
