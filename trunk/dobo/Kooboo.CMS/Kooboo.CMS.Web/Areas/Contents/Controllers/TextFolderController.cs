...
namespace Kooboo.CMS.Web.Areas.Contents.Controllers
{
    public class TextFolderController : ManagerControllerBase
    {
        ...
        public ActionResult Index(string FolderName, string search)
        {
        ...
        public ActionResult Create(TextFolder model, string folderName)
        {
        ...
        [Kooboo.CMS.Web.Authorizations.Authorization(AreaName = "Contents", Group = "", Name = "Folder", Order = 99)]
        [HttpPost]
        public ActionResult Edit(TextFolder model, string fullName, string successController)
        {
            JsonResultEntry resultEntry = new JsonResultEntry() { Success = true };
            try
            {
        ...
        public ActionResult GetSchemaFields(string name)
        {
