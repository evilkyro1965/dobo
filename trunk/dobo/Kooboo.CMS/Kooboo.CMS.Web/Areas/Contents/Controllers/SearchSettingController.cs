...
namespace Kooboo.CMS.Web.Areas.Contents.Controllers
{
    ...
    public class SearchSettingController : ManagerControllerBase
    {
        ...
        [HttpPost]
        public ActionResult Create(SearchSetting model)
        {
        ...
        [HttpPost]
        public ActionResult Edit(SearchSetting model)
        {
            var entry = new JsonResultEntry();
        ...
        [HttpPost]
        public ActionResult Delete(SearchSetting[] model)
        {
            var entry = new JsonResultEntry();
        ...
        public ActionResult GetFields(string folderPath)
        {
