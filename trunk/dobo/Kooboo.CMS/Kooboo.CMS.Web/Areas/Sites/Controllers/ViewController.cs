...
namespace Kooboo.CMS.Web.Areas.Sites.Controllers
{
    ...
    public class ViewController : PathResourceControllerBase<Kooboo.CMS.Sites.Models.View, ViewManager>
    {
        ...
        public ActionResult DeleteViewNamespace(View[] model, string[] selectedNamespace)
        {
            JsonResultEntry entry = new JsonResultEntry();
        ...
        public ActionResult DataRuleGridForms(DataRuleSetting[] DataRules, string engine)
        {
        ...
        #region Versions
        public ActionResult Version(View view)
        {
            view.Site = Site;
            var model = Manager.VersiongLogger.AllVersions(view);
            return View(model);
        }
        public ActionResult Revert(View view, int version)
        {
            var entry = new JsonResultEntry();
        ...
        public ActionResult PreviewVersion(View view, int version)
        {
            view.Site = Site;
            if (!string.IsNullOrWhiteSpace(Site.Repository))
            {
