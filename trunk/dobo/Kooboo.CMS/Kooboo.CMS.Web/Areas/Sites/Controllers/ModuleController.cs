...
namespace Kooboo.CMS.Web.Areas.Sites.Controllers
{
    ...
    public class ModuleController : AdminControllerBase
    {
        ...
        [HttpPost]
        public ActionResult Include(ModuleListInSiteModel[] model)
        {
        ...
        [HttpPost]
        public ActionResult Exclude(string moduleName)
        {
            JsonResultEntry result = new JsonResultEntry(ModelState);
        ...
        [ValidateInput(false)]
        public ActionResult Scaffold(string moduleName, string moduleUrl)
        {
