...
{
    // Kooboo.CMS.Account.Models.Permission.Sites_Page_InlineEditPermission
    [Kooboo.CMS.Web.Authorizations.Authorization(AreaName = "Sites", Group = "Page", Name = "Inline editing", Order = 1)]
    public class InlineEditingController : AdminControllerBase
    {
        #region Content
        [HttpPost]
        public ActionResult CopyContent(string schema, string uuid)
        {
        ...
        [HttpPost]
        public ActionResult DeleteContent(string schema, string uuid)
        {
            var result = new JsonResultEntry();
            try
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult UpdateContent(string schema, string uuid, string fieldName, string value)
        {
            var result = new JsonResultEntry();
            try
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult UpdateHtml(string positionId, string pageName, string value, bool? _draft_)
        {
            var result = new JsonResultEntry();
            try
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult UpdateLable(string key, string category, string value)
        {
            var result = new JsonResultEntry();
            try
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult UpdateHtmlBlock(string blockName, string value)
        {
            var result = new JsonResultEntry();
            try
            {
        ...
        #region Variables
        public ActionResult Variables(string pageName, string _draft_)
        {
            var vars = PageDesignController.jsSerializer.Serialize(new
            {
                ...
                block_js = new
                {
                    ...
                    errorMessage = "Network error, the action has been cancelled".Localize(),
