...
namespace Kooboo.CMS.Sites.Services
{
    public class CodeSnippetManager
    {
        ...
        //public virtual CodeSnippet GetCodeSnippet(string codeName)
        //{
        //    var physicalPath = BasePath;
        //    if (Directory.Exists(physicalPath))
        //    {
        //        CodeSnippet codeSnippet = new CodeSnippet() { Name = codeName };
        //        var codeFile = Path.Combine(physicalPath, codeName + FileExtension);
        //        codeSnippet.Code = IO.IOUtility.ReadAsString(codeFile);
        //        return codeSnippet;
        //    }
        //    return null;
        //}
