...
{
    public class LayoutManager : PathResourceManagerBase<Layout>
    {
        ...
        public void Localize(string name, string fromSite, Site targetSite)
        {
            ...
            var source = new Models.Layout(sourceSite, name);
            ((ILayoutProvider)Provider).Localize(source, targetSite);
        }

        public IEnumerable<Page> RelationsPages(Layout layout)
        {
