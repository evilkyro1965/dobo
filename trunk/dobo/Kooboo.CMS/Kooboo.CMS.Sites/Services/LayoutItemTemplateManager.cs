...
namespace Kooboo.CMS.Sites.Services
{
    public class LayoutItemTemplateManager : ItemTemplateManager
    {
        ...
        public IEnumerable<LayoutSample> GetLayoutSamples(string engineName)
        {
            ...
            foreach (var item in itemTemplates)
            {
                ...
                {
                    var settingEntryName = "setting.config";
        ...
        public LayoutSample GetDefaultLayoutSample(string engineName)
        {
        ...
        public LayoutSample GetLayoutSample(string engineName, string templateName)
        {
