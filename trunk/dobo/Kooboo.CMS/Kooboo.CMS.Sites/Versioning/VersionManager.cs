...
namespace Kooboo.CMS.Sites.Versioning
{
    public class VersionManager
    {
        ...
        {
            VersionManager.RegisterVersionLogger(new Kooboo.CMS.Sites.Persistence.FileSystem.PageProvider.PageVersionLogger());
            VersionManager.RegisterVersionLogger(new Kooboo.CMS.Sites.Persistence.FileSystem.LayoutProvider.LayoutVersionLogger());
            VersionManager.RegisterVersionLogger(new Kooboo.CMS.Sites.Persistence.FileSystem.ViewProvider.ViewVersionLogger());
            VersionManager.RegisterVersionLogger(new Kooboo.CMS.Sites.Persistence.FileSystem.HtmlBlockProvider.HtmlBlockVersionLogger());
        }
