...
namespace Kooboo.CMS.Content.Models
{
    ...
    [DataContract]
    public class Workflow : IRepositoryElement, IPersistable
    {
        public Workflow() { }
    ...
    [DataContract]
    public class PendingWorkflowItem : IRepositoryElement, IPersistable
    {
        [DataMember(Order = 1)]
    ...
    [DataContract]
    public class WorkflowHistory : IRepositoryElement, IPersistable
    {
