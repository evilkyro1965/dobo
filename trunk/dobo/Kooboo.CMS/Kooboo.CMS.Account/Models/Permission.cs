...
namespace Kooboo.CMS.Account.Models
{
    public class Permission
    {
        ...
        public static Permission Sites_Page_InlineEditPermission = new Permission() { AreaName = "Sites", Group = "Page", Name = "Inline editing" };
        public static Permission Sites_Page_PublishPermission = new Permission() { AreaName = "Sites", Group = "Page", Name = "Publish" };
