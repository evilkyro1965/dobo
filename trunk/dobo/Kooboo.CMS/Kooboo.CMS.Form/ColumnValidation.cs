...
namespace Kooboo.CMS.Form
{
    ...
    {
        public static Func<ValidationType, string> DefaultErrorMessageAccessor = v => SR.System_ComponentModel_DataAnnotations_Resources.GetString(string.Format("{0}Attribute_ValidationError", v.ToString()));
